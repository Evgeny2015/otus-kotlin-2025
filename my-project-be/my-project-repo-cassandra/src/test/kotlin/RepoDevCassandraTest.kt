...
class CassandraTest {
    ...
    class RepoDevCassandraCreateTest : RepoDevCreateTest() {
    ...
    class RepoDevCassandraReadTest : RepoDevReadTest() {
        override val repo = DevRepoInitialized(
            initObjects = initObjects,
            repo = repository()
        )
    ...
    class RepoDevCassandraUpdateTest : RepoDevUpdateTest() {
        override val repo = DevRepoInitialized(
            initObjects = initObjects,
    ...
    class RepoDevCassandraDeleteTest : RepoDevDeleteTest() {
        override val repo = DevRepoInitialized(
            initObjects = initObjects,
            repo = repository()
        )
    ...
    class RepoDevCassandraSearchTest : RepoDevSearchTest() {
        override val repo = DevRepoInitialized(
            initObjects = initObjects,
            repo = repository()
        )
